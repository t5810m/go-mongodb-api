...
func NewJobHandler(service interfaces.JobService) *JobHandler {
...
// GetJobsByUser handles GET /users/:userId/jobs request
func (h *JobHandler) GetJobsByUser(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	userID := chi.URLParam(r, "userId")

	jobs, err := h.service.GetJobsByUser(ctx, userID)
	if err != nil {
		http.Error(w, "Failed to retrieve jobs", http.StatusInternalServerError)
		return
	}
