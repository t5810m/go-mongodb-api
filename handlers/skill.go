...
type SkillHandler struct {
	service interfaces.SkillService
}

// NewSkillHandler creates a new skill handler
func NewSkillHandler(service interfaces.SkillService) *SkillHandler {
...
// UpdateSkill handles PUT /skills/{id} request
func (h *SkillHandler) UpdateSkill(w http.ResponseWriter, r *http.Request) {
	...
	updated, err := h.service.UpdateSkill(ctx, skillID, &skill)
	if err != nil {
		http.Error(w, "Skill not found", http.StatusNotFound)
		return
	}
