...
func (r *UserRepository) GetAll(ctx context.Context, page, limit int, filters map[string]string, sort, order string) ([]models.User, int64, error) {
	...
	sortableFields := []string{"first_name", "last_name", "email", "role", "verified", "active", "created_time"}
...
// Update updates allowed fields of a user and returns the updated document
